public class PersonInfo5 {
    ...
    public static String firstName = "Cagan";
    public static String lastName = "Eraydin";
    public static int studentNo = 300059504;
    public static String description = "likes basketball and videogames";
