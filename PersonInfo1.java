public class PersonInfo1 {
    ...
    public static String firstName = "Mika";
    public static String lastName = "Thurler";
    public static int studentNo = 300056543;
    public static String description = "Likes to ski and skateboard.";
