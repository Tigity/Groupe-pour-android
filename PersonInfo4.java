public class PersonInfo4 {
    ...
    public static String firstName = "Eda Su";
    public static String lastName = "Biçer";
    public static int studentNo = 300064081;
    public static String description = "I like chocolates and coffees";
